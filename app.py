    ...
    if database is not None:
        ...
        for _, row in database.iterrows():
            ...
            if question_cleaned == user_message_cleaned:
                return row["Answer"]
    return "I’m sorry, I didn’t quite understand that. Could you rephrase or ask something else? 🤔"
...
def chatbot():
    ...
    if request.method == "POST":
        ...
        if user_message:
            ...
            elif user_message.lower() in ["what is my name", "tell me my name"]:
...
def chat():
    ...
    return jsonify({"bot_response": "Sorry, I couldn't understand your message."})
